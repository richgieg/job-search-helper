...
describe('generateSampleAppExportFile', () => {
  it('shifts built-in sample dates relative to the requested now', () => {
    ...
    expect(generated.exportedAt).toBe('2026-03-17T12:00:00.000Z')
    expect(generated.data.profiles['profile-base-software-engineer']?.createdAt).toBe('2026-03-08T09:00:00.000Z')
    expect(generated.data.profiles['profile-base-software-engineer']?.updatedAt).toBe('2026-03-17T12:00:00.000Z')
    ...
    expect(generated.data.jobs['job-atlas-health']?.appliedAt).toBe('2026-02-27T14:30:00.000Z')
    expect(generated.data.interviews['interview-atlas-screen']?.startAt).toBe('2026-03-04T15:00:00.000Z')
    expect(generated.data.interviews['interview-summit-architecture']?.startAt).toBe('2026-03-19T19:00:00.000Z')
